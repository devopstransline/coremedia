...
public class ActionTestBaseConfiguration {
  ...
  @Bean
  public TLCExchangeFacade gcExchangeFacade() {
    TLCExchangeFacade mock = Mockito.mock(TLCExchangeFacade.class, invocation -> {
      throw new IllegalStateException("Unexpected method called on TLCExchangeFacade Mock. You may require to extend your mock setup. Invocation: " + invocation);
    });
    return mock;
  }
