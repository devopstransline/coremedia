...
For quicker test feedback set the following integer parameters in the TranslineSettings `/Settings/Options/Settings/Transline`
...
Especially on updates of `tlc-restclient` you should run the half-automatic
test `DefaultTLCExchangeFacadeContractTest`. Read the JavaDoc to know how to
...
In order run the test you need to create a file with the name [.tlc.properties](example.tlc.properties.txt) in your user 
home folder

## Scenario: Happy Path

1. Login as Rick C.
2. Open the TranslineSettings `/Settings/Options/Settings/Transline`
    1. type should not be set to “mock”
    2. dayOffsetForDueDate should be set to 20
    3. Credentials for tlc should be entered (automatic workflow key)
...
2. Open the TranslineSettings `/Settings/Options/Settings/Transline`
    1. type should not be set to “mock”
    2. dayOffsetForDueDate should be set to 20
    3. Credentials for tlc should be entered (manual workflow key)
3. Choose an article and drag it into the “Localization Workflows” drop area
    1. A StartTranslation window should pop up
    2. There should be no warnings or errors
    3. The Due Date should be set to the current dateTime plus 20 days
...
5. Open the “pending” area and select the started workflow
    ...
    2. Multi-selection is possible. If you select a "normal" and a Transline workflow, the button remains deactivated. It is also  possible to select and cancel multiple Transline workflows at once.
6. Press the “X”
...
4. Click “Start”
    1. The dialog should close without any error
    2. In the “pending” area from “Localization Workflows” the workflow should pop up
5. Login to the Transline Connect Dashboard
...
## Scenario: Cancellation in Transline
...
4. Click “Start”
    1. The dialog should close without any error
    2. In the “pending” area from “Localization Workflows” the workflow should pop up
5. Login to Transline project director by using the credentials for the manual
    workflow account.
...
3. Choose an article and drag it into the “Localization Workflows” drop area
    ...
    2. There should be no warnings or errors
    3. The Due Date should be set to the current dateTime plus 20 days
4. Reset the “username” in the TranslineSettings to something wrong
5. Click “Start”
    1. The dialog should close without any error
    2. In the “pending” area from “Localization Workflows” the workflow should pop up
...
9. Reset the “username” in the TranslineSettings to something wrong
...
12. Wait for the Workflow to appear in the inbox
    ...
    3. You have the ability to “Reject Changes without cancelling the submission at Transline.” or “Continue and Retry”
